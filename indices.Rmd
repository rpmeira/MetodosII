...
$$
I_L = \frac{\sum_{i=1}^n \left(\frac{p_{it}}{p_{i0}}\right) \times \color{red}{(p_{i0}q_{i0})}}{\sum_{i=1}^n \color{red}{(p_{i0}q_{i0})}}
    = \boxed{ \frac{\sum_{i=1}^np_{it} \times q_{i0}}{\sum_{i=1}^n p_{i0} \times q_{i0}} }
$$
